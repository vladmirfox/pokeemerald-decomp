...
#define FLAG_SYS_STARTER_GET                         (SYSTEM_FLAGS + 0x3) // Used to show Starter Event completion
...
#define FLAG_START_KIT                              (SYSTEM_FLAGS + 0x83) // Unused Flag

#define FLAG_RECEIVED_POKEDEX_FROM_BIRCH            (SYSTEM_FLAGS + 0x84)

#define FLAG_PT_PASS                                (SYSTEM_FLAGS + 0x85) // Unused Flag
#define FLAG_PT_FAIL                                (SYSTEM_FLAGS + 0x86) // Unused Flag
#define FLAG_PT_REJECT                              (SYSTEM_FLAGS + 0x87) // Unused Flag
#define FLAG_AIDE_AWAKE                             (SYSTEM_FLAGS + 0x88) // Unused Flag
#define FLAG_AIDE_ASLEEP                            (SYSTEM_FLAGS + 0x89) // Unused Flag
